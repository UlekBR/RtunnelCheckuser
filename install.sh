...
if [[ $arch == "x86_64" || $arch == "amd64" || $arch == "x86_64h" ]]; then
    ...
    curl -o "/opt/rt/check" -f "https://raw.githubusercontent.com/UlekBR/RtunnelCheckuser/main/x86"
elif [[ $arch == "aarch64" || $arch == "arm64" || $arch == "armv8-a" ]]; then
    echo "Sistema baseado em arm64 (64-bit ARM)"
    curl -o "/opt/rt/check" -f "https://raw.githubusercontent.com/UlekBR/RtunnelCheckuser/main/arm"
else
